...
def run_main():
    ...
    MC_0 = MotorController(50, 2700)    # Burn in, 50% for 45 mins (2700 sec)
    ...
    try:
        ...
        if (rms1[4] in range (9, 20)) and (rms1[6] in range(9, 20)) and (rms1[8] in range(9, 20)) and (rms1[12] > 200) and (rms1[13] < 400):
            rms1_msg = "PASS"
        else:
            rms1_msg = "FAIL"

        if (rms2[4] in range (9, 20)) and (rms2[6] in range(9, 20)) and (rms2[8] in range(9, 20)) and (rms2[12] > 1400) and (rms2[13] < 1600):
            rms2_msg = "PASS"
        else:
            rms2_msg = "FAIL"
